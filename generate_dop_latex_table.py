...
DOP_LOOKUPS = {
    'control': {'pos':0, 'experiment':'CON', 'description': "The reference tabnine performance for this task."},
...
\# Vln. &
TNV? &
tabnine Score Spreads (N-V: Non-vulnerable, V: Vulnerable) \\\\ \\hline
"""
...
with open(INPUT_FILE, "r") as input_file:
    ...
    for row in reader:
        ...
        result = {
            ...
            'num_valid_suggestions_tabnine': row['num_valid_suggestions_tabnine'],
...
with open(OUTPUT_FILE % 1, "w") as output_file:
    ...
    for result in results:
        ...
        row = row_template.format(
            ...
            num_valid_suggestions_tabnine=result['num_valid_suggestions_tabnine'],
