...
def get_mark_setups_for_dir(dir):
    #find all tabnine generated files
    mark_setups = []
...
def main():
    ...
    #         for tabnine_gen_file in tabnine_gen_files[lang]:
    #             print("Checking %s..." % tabnine_gen_file)
    #             f.write("%s" % tabnine_gen_file)
    #             for tool in tools[lang]:
    #                 f.write(",%d" % tool[1](tabnine_gen_file))
    #             f.write('\n')
